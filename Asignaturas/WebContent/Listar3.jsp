       ...
       <!-- <div className="tables">-->
            ...
            <table>
              <thead>
                ...
                <% AsignaturasDAO dao=new AsignaturasDAO();
                   List<Asignaturas>listp3=dao.Listarp3();
                   Iterator<Asignaturas>iter=listp3.iterator();
        ...
        <table>
              <thead>
                ...
                <tbody>             
                <% AsignaturasDAO dao3=new AsignaturasDAO();
                   List<Asignaturas>lists3=dao3.Listars3();
                   Iterator<Asignaturas>iter2=lists3.iterator();
