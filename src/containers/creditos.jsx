      ...
      <div>
        ...
        <table cellspacing="15" cellpadding="5">
          <tr>
            ...
            <td>
              <img src={JasonA} alt="" width="200" height="200" />
            </td>
            <div>
              <strong>Jason, Arrocha</strong>
              <br />
              Encargado de:
              <ul>
                <li>StoryBoards</li>
            ...
            <td>
              <img src={JasonW} alt="" width="200" height="200" />
            </td>
            <div>
              <strong>Jason,Wedderburn</strong>
              <br />
              Encargado de:
              <ul>
                <li>StoryBoards</li>
          ...
          <tr>
            <td />
            <td>
              <img src={JosephM} alt="" width="200" height="200" />
            </td>
            <div>
              <strong>Joseph, Miranda</strong>
              <br />
              Encargado de:
              <ul>
                <li>StoryBoards</li>
            ...
            <td>
              <img src={IrvingD} alt="" width="200" height="200" />
            </td>
            <div>
              <strong>Irving, Dominguez</strong>
              <br />
              Encargado de:
              <ul>
